...
function ReservationDisplay({ imgLink, reservation, reservations, setReservations}) {
    ...
    function confirmModifications() {
        // TODO: Finish this and code backend
        setRoomErrHidden('hidden');
        setDateErrHidden('hidden');
        ...
        <div className="res-display">
            ...
            >
                ...
                <div>
                    ...
                    <p>Please contact a staff member to assist you</p>
                </div> :
                <div>
                    ...
                    <div className={"error " + roomErrHidden}>Unable to confirm modifications because these</div>
                    <div className={"error " + roomErrHidden}>rooms are unavailable on selected dates: </div>
                    <div className={"error " + unknownErrHidden}>Unknown error occurred, please contact staff</div>
                    {unavailableRooms.length !== 0 && unavailableRooms[0] !== -1 && unavailableRooms.map((room) => (<span>{room} </span>))}
                    <div className={"error " + dateErrHidden}>Please ensure your dates are correct</div>
                </div>
            }
            </Modal>
