...
function ChangeCredentials() {
    ...
    const handleChangeUsername = (e) => {
        ...
        fetch('http://localhost:8080/accounts/changeManagerUsername?newUsername=' + newUsername, {
            mode: 'cors',
            method: 'POST',
            headers: {
    ...
    const handleChangePassword = (e) => {
        ...
        fetch('http://localhost:8080/accounts/changeManagerPassword?newPassword=' + newPassword, {
            mode: 'cors',
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
